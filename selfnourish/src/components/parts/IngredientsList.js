...
const IngredientsList = (props) => {
    ...
    return(
        ...
        <section className="recipe-ingredients-list">
            ...
            <h3 className="recipe-ingredient-heading heading-3"><img className="ingredients-image" src="./images/icon/ingredient.svg" alt="" aria-hidden="true"></img>Ingredients:</h3>
