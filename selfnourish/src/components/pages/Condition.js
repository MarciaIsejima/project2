...
class Condition extends React.Component {
  constructor(props) {
    ...
    this.state = {
      error: null,
      selectedCondition: {id: 0, nutrientConstraints: "&nutrition.NA.max=0.12&nutrition.CA.min=0.165&nutrition.FE.min=0.0021"},
			selectedRecipeId: '',
  ...
  render() {
		...
		if (this.state.selectedRecipeId!=='') {
			return <Redirect to={'/recipe/single/'+this.state.selectedRecipeId+'/'+this.state.selectedCondition.nutrientConstraints} />
		}

		if (this.state.redirectToSearch) {
			return <Redirect to={'/recipe/search/'+this.state.selectedCondition.nutrientConstraints} />
		}
